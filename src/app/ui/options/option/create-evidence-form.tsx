    ...
    <div className="mx-auto">
            ...
            <form className="max-w-sm" onSubmit={handleSubmit}>
              ...
              <div className="mb-5">
                  ...
                  <input type="date" id="date"  className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" value={inputDate} onChange={(e) => setInputDate(e.target.value)} required/>
              </div>
              <div className="mb-5">
              ...
              <div className="mb-5">
                  ...
                  <input className="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="actCode" type="text" value={actCode} readOnly/>
              </div>
              <div className="mb-5">
                  <label htmlFor="parcelId" className="block mb-2 text-sm font-medium text-gray-900">Parcel Id</label>
                  <input className="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="parcelId" type="text" value={parcelId} readOnly/>
              </div>
